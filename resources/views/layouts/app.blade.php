        ...
        <li class="pc-item pc-caption">
         ...
         <li class="pc-item">
          <a href="{{ route('home') }}" class="pc-link">
            ...
            <span class="pc-mtext">Principal</span>
          </a>
        </li>
         <li class="pc-item">
          <a href="{{ route('escuelas.index') }}" class="pc-link">
            <span class="pc-micon">
              <svg class="pc-icon">
                <use xlink:href="#custom-story"></use>
              </svg>
            </span>
            <span class="pc-mtext">Escuelas</span>
          </a>
        </li>
         </li>
         <li class="pc-item">
          <a href="{{ route('profesores.index') }}" class="pc-link">
            <span class="pc-micon">
              <svg class="pc-icon">
                <use xlink:href="#custom-story"></use>
              </svg>
            </span>
            <span class="pc-mtext">Profesores</span>
          </a>
        </li>
         </li>
         </li>
         <li class="pc-item">
          <a href="{{ route('estudiantes.index') }}" class="pc-link">
            <span class="pc-micon">
              <svg class="pc-icon">
                <use xlink:href="#custom-story"></use>
              </svg>
