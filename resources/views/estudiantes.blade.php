...
@section("content")
                    ...
                    @foreach($estudiantes as $estudiante)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route("estudiantes.destroy", $estudiante->id) }}" class="text-danger me-2">Eliminar</a>

                                {{-- Botón editar: abre modal y carga valores en los inputs mediante JS --}}
                                <a href="#"
                                   data-bs-toggle="modal"
                                   data-bs-target="#updateEstudiantes"
                                   onclick="
    ...
    <form method="post" action="{{ route('estudiantes.store') }}" enctype="multipart/form-data">
        @csrf
        <div class="modal fade" id="agregarEstudiante" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="nombre_responsable" id="nombre_responsable" required>
                        </div>
                         <div class="mb-3">
                            <label for="telefono_responsable" class="form-label">Teléfono del responsable</label>
                            <input type="text" class="form-control" id="telefono_responsable" name="telefono_responsable" placeholder="Ingrese el teléfono del contacto">
                        </div>
                        <div class="col-md-6">
                            <label for="email_responsable" class="form-label">Correo del responsable</label>
                            <input type="email_responsable" class="form-control" name="email_responsable" id="email_responsable" required>
                        </div>
                        <div class="col-md-6">
                            <label for="parentesco_responsable" class="form-label">parentesco del responsable</label>
                            <input type="text" class="form-control" name="parentesco_responsable" id="parentesco_responsable" required>
                        </div>
                         <div class="mb-3">
